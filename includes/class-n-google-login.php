...
class N_Google_Login
{
	 ...
	 * @since    1.0.0
	 * @access   protected
	 * @var      N_Google_Login_Loader    $loader    Maintains and registers all hooks for the plugin.
	 */
	protected $loader;
	...
	public function __construct()
	{
		...
		$this->plugin_name = 'n-google-login';
	 ...
	 *
	 * - N_Google_Login_Loader. Orchestrates the hooks of the plugin.
	 * - N_Google_Login_i18n. Defines internationalization functionality.
	 * - N_Google_Login_Admin. Defines all hooks for the admin area.
	 * - N_Google_Login_Public. Defines all hooks for the public side of the site.
	 *
	 ...
	 *
	 * Uses the N_Google_Login_i18n class in order to set the domain and to register the hook
	 * with WordPress.
	 *
	 * @since    1.0.0
	 * @access   private
